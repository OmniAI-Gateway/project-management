...
object AnthropicContentSerializer : KSerializer<AnthropicContent> {
    ...
    override fun serialize(
        encoder: Encoder,
        value: AnthropicContent,
    ) {
        val jsonEncoder =
            encoder as? JsonEncoder ?: throw SerializationException("AnthropicContentSerializer only works with JSON")
    ...
    override fun deserialize(decoder: Decoder): AnthropicContent {
        val jsonDecoder =
            decoder as? JsonDecoder ?: throw SerializationException("AnthropicContentSerializer only works with JSON")
        return when (val element = jsonDecoder.decodeJsonElement()) {
            ...
            is JsonArray -> {
                ...
                throw SerializationException("Expected content to be a string or an array")
            }
        }
    }
}
