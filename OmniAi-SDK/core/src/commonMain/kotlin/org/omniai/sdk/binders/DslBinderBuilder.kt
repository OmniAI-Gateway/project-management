...
class DslBinderBuilder {
    ...
    infix fun String.mappedTo(domainKey: AttributeKey<String>): Pair<String, AttributeKey<String>> {
        return this to domainKey
    }
    ...
    fun <T : Any> String.mappedTo(domainKey: AttributeKey<T>, decode: (String) -> T?): TypedPair<T> {
        return TypedPair(this, domainKey, decode)
    }
