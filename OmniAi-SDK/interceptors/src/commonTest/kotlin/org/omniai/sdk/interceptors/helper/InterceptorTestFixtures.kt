...
class StaticChain(private val result: PipelineResult) : InterceptorChain {
    var callCount = 0
...
class CapturingChain(private val result: PipelineResult = PipelineResult.Unary(fakeResponse())) : InterceptorChain {
...
class FakeOutbound(
    ...
    private val unaryResult: Either<DomainError, CommonResponse> = success(fakeResponse(provider = provider, model = modelName)),
