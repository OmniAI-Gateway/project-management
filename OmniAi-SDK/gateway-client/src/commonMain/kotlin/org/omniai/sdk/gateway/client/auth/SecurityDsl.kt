...
class SecurityDsl {
    ...
    internal fun build(): SecurityConfig {
        return SecurityConfig(authenticationConfig, authorizationConfig)
    }
}
class AuthorizationDsl {
    ...
    internal fun build(): AuthorizationConfig {
        return AuthorizationConfig(pdp, inputProvider)
    }
}
