...
sealed interface PipelineResult {
    ...
    data class Stream(
        val eventFlow: Flow<CommonResponseEvent>,
    ) : PipelineResult
...
fun PipelineResult.requireUnaryResponse(): Either<DomainError, CommonResponse> =
    when (this) {
...
fun PipelineResult.requireStreamEvents(): Either<DomainError, Flow<CommonResponseEvent>> =
    when (this) {
