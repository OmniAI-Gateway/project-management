...
class StubOpaqueTokenIntrospector : OpaqueTokenIntrospector {
    // Implementação temporária até existir cliente real de introspection no AS.
...
class OpaqueAwareTokenAuthenticator(
    ...
    // Encaminha JWT para validação local e, se ativo, faz introspection para tokens opaque.
