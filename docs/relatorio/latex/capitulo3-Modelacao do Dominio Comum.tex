...
\end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{../images/DiagramaClassesCommonRequest}
    ...
    Common\-GenerationConfig & topP & Double? & Probabilidade cumulativa (nucleus sampling). \\ \hline
...
\end{table}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\textwidth]{../images/DiagramaClassesCommonResponse}
