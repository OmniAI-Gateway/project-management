...
\section{\textbf{Model Context Protocol (MCP)}}
...
A comunicação entre clientes e servidores é realizada através de mensagens JSON-RPC e pode utilizar diferentes mecanismos de transporte, incluindo \texttt{stdio}, \textbf{HTTP}, \textbf{SSE} e \textbf{WebSocket} \cite{mcp_architecture}.
