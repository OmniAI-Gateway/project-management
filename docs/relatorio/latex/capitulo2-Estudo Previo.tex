...
\caption{Fluxo de comunicação MCP}
...
pelo cliente junto de um \textit{Identity Provider} (IdP).

Além da autenticação, o MCP incentiva a utilização de \textit{OAuth scopes} para
implementar uma autorização granular. Desta forma, é possível limitar os
recursos e as ferramentas a que cada cliente ou agente de IA pode aceder,
seguindo o princípio do menor privilégio (\textit{Principle of Least
Privilege}), reduzindo assim a superfície de ataque e o impacto potencial de um
acesso indevido.
