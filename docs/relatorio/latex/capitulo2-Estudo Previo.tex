...
\end{table}
    ...
    Com base nos pedidos executados durante o estudo, identificou se os campos JSON mais relevantes de cada fornecedor. A Figura~\ref{fig:json-request-skeletons} indentifia as estruturas dessas mensagens, evidenciando as diferenças de organização e de nomenclatura entre os três fornecedores. Os exemplos JSON completos dos pedidos encontram-se no Apêndice~\ref{apx:json-requests}.
