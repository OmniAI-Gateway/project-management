...
Por fim, ao utilizar nasua estrutura o formato JSON, como referido anteriormente, o conteúdo das mensagens, tal como a estrutura de parâmetros necessários para executar uma ferramenta, pode ser validado de forma direta e padronizada com recurso a JSON Schema.
...
\hline
\textbf{Autenticação e autorização} & Baseada nas permissões do sistema operativo e no controlo de acesso local do utilizador. & Requer a implementação de mecanismos adicionais (como OpenID Connect ou JWT) para garantir um acesso seguro. \\
\hline
