...
\textbf{JSON-RPC} \texttt{initialize}, na qual declara a versão do protocolo
...
\textit{endpoint} adicional. Este mecanismo substitui o transporte legado
