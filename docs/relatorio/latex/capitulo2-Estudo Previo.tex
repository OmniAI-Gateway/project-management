...
enviar várias mensagens ou notificações, essa mesma ligação pode ser convertida de
forma incremental num \textit{stream} SSE, sem que seja necessário recorrer a um
\textit{endpoint} adicional. Este mecanismo substitui o transporte 
