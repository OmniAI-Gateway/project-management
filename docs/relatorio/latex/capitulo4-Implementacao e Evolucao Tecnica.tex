...
interceptors {
   ...
   \section{Distribuição Multiplataforma}
    ...
    \begin{itemize}
        \item \textbf{Módulo Comum:} Contem o código queé escrito uma única vez e partilhado por todos os ambientes de execução, garantindo a consistência das regras.
