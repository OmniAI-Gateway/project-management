...
\end{table}
    ...
    A Tabela~\ref{tab:response-parametros} reúne os campos do domínio de \texttt{CommonResponse}, incluindo o objeto base, as escolhas e os eventos de \textit{streaming}.
